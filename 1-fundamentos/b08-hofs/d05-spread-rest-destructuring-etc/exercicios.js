...
const sumAllNumbers = (...numbers) => numbers.reduce((total, number) => total + number);
console.log(sumAllNumbers(2, 3, 4, 5));
console.log(sumAllNumbers(12, 2));
console.log(sumAllNumbers(2, 3, 4, 5, 6, 1));
...
//     const { name, age, likes } = person; // Assim nao funciona 
...
//     return obj
//     .filter((person) => person.bornIn <= 2000)
...
// const toObject = ([item1, item2, item3]) => ({
//     car: item1,
//     manufacturer: item2,
//     year: item3,
// });
...
// deste objeto e o valor de cada chave é um array de strings, representando os meses daquela 
// estação. A partir deste objeto, desestruture as estações do ano e espalhe-as em um array de 
// meses do ano.
