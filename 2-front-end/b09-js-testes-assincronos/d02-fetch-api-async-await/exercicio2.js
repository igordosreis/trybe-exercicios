// // Com essa sintaxe, o objeto com os dados da API só é acessível com o data.data do segundo .then.
// // Mesmo se fosse criada uma variavel para receber o fetch, ela só seria uma Promise.
// const fetchCoins = () => {  
